...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _deleteTransaction(String tx_id) {
    setState(() {
      _userTransactions.removeWhere((element) {
        return element.id == tx_id;
      });
    });
  }

  void _startAddBewTransaction(BuildContext ctx) {
  ...
  Widget build(BuildContext context) {
    ...
    final appBar = AppBar(
      ...
      actions: <Widget>[
        IconButton(
          icon: Icon(Icons.add),
          onPressed: () => _startAddBewTransaction(context),
        ),
      ],
    );
